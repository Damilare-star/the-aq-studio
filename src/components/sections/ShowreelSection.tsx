    ...
    <section id="showreel" className="bg-[#050505] section-padding">
      <div className="container-wide">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-[rgba(255,255,255,0.40)] text-sm leading-relaxed md:max-w-xs">
        ...
        <motion.div
          ...
          style={{ aspectRatio: '16/9', background: '#090909', border: '1px solid rgba(255,255,255,0.07)' }}
        >
          <video
            ref={videoRef}
            src="/showreel.mp4"
          ...
          {!playing && <div className="absolute inset-0 bg-[rgba(5,5,5,0.45)] pointer-events-none" />}

          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, transparent 50%, rgba(5,5,5,0.55) 100%)' }} />
          ...
          >
            ...
            >
              {playing ? (
                ...
                <span className="block ml-1" style={{ width: 0, height: 0, borderTop: '9px solid transparent', borderBottom: '9px solid transparent', borderLeft: '16px solid white' }} />
              )}
            </motion.div>
            {!playing && (
              <span className="absolute mt-24 text-[10px] tracking-[0.24em] uppercase text-[rgba(255,255,255,0.35)]">Watch Showreel</span>
            )}
          </button>

          <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 flex items-end justify-between pointer-events-none">
            <div>
            ...
            <div className="flex items-center gap-2">
              <motion.span animate={{ opacity: [1, 0.3, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="block w-1.5 h-1.5 rounded-full bg-[#8B5CF6]" />
